-- =============================================================================
-- 0006 — Índices de performance + trigger updated_at em lote
--
...
--
-- HISTÓRICO: antes era um arquivo manual fora do journal
-- (drizzle/0003_indices_e_trigger_wallyson.sql, rodado à mão via psql -f).
-- Foi promovido a migration custom do drizzle-kit para entrar no journal e ser
-- aplicado automaticamente por `npm run db:migrate` — sem passo manual.
-- =============================================================================
